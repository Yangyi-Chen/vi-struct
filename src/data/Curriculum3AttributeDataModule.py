...
class Curriculum3AttributeDataModule(pl.LightningDataModule):
    ...
    def __init__(self, config:dict, tokenizer: OFATokenizer):
        ...
        self.attribute_dataset = ConcatDataset([classify_image, detection_coco, detection_object365, detection_openimages, attribute_lsa, attribute_ovad])
