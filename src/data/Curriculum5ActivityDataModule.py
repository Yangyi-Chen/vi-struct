...
from .activity import ActivityDataModule
...
class Curriculum5ActivityDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        activity_loader = torch.utils.data.DataLoader(
        ...
        return {'object': object_loader, 'relation': relation_loader, 'activity': activity_loader}
    ...
    def __init__(self, config:dict, tokenizer: OFATokenizer):
        ...
        activity = ActivityDataModule(activity_config, tokenizer).train_dataset
        ...
        self.object_dataset = ConcatDataset([classify_image, detection_coco, detection_object365, detection_openimages, attribute_lsa])
        self.relation_dataset = scenegraphVG
        self.activity_dataset = activity
