...
class Curriculum2ObjectDataModule(pl.LightningDataModule):
    ...
    def __init__(self, config:dict, tokenizer: OFATokenizer):
        ...
        self.object_dataset = ConcatDataset([classify_image, detection_coco, detection_object365, detection_openimages])
